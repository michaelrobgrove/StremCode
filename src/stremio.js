...
export function buildDefaultManifest(origin) {
  return {
    ...
    version: '2.1.3',
    name: 'StremCodes',
    description: 'Connect your Xtream Codes IPTV subscription to Stremio. v2.1.3a — Movies & series matched via TMDB with fuzzy title fallback. Credentials AES-256 encrypted, never stored.',
